...
namespace AdventOfCode2020.Day25
{
    internal class AOC_Day25
    {
        ...
        {
            var keyCard = new RFIDevice(2084668);
            var doorLock = new RFIDevice(3704642);
            ...
            Console.WriteLine(scannedKeyCard.EncryptionKey);
        }
    ...
    {
        private readonly int Constant = 20201227;
        ...
        public RFIDevice BreakEncryptionKey(RFIDevice device, RFIDevice other)
        {
            ...
            // Of course, we can raise an exception on such occasion, but why?
            // What we are doing it illegal anyways, so, let's just get it done quick and
            // rest on the bed.
